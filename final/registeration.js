    ...
    var registerAdmin = document.getElementById('registerbutton');
		...
		if(adminPassword === adminConfirmPassword){
            ...
            //if admin is not registered then the admin value are store in the object of admin Details
                ...
                //after storing the admin details in object we will set that value on session storage

				sessionStorage.setItem('AdminRegistrationDetails',JSON.stringify(adminDetails));
				window.open("login.html");
